Welcome to reportlab's documentation!
=====================================
...
This `dates back to 2010 <https://hg.reportlab.com/hg-public/reportlab/log/tip/docs/source/index.rst>`_, so I do not really expect it to change in the near future.
